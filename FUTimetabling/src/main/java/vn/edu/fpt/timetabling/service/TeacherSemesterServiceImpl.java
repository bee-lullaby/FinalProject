...
public class TeacherSemesterServiceImpl implements TeacherSemesterService {
	...
	@Override
	public void addTeacherSemesterFromFile(File teacherSemesters, int semesterId)
			throws IOException {
	...
	public List<TeacherSemester> listTeacherSemestersBySemester(int semesterId, boolean jointTeacherCourseSemesters, boolean jointTimetables) {
		return teacherSemesterDAO.listTeacherSemestersBySemester(semesterId, jointTeacherCourseSemesters, jointTimetables);
	}
	...
	public TeacherSemester getTeacherSemesterByAccount(int semesterId, String account, boolean jointTeacherCourseSemesters,
			boolean jointTimetables) {
		return teacherSemesterDAO.getTeacherSemesterByAccount(semesterId, account, jointTeacherCourseSemesters, jointTimetables);
	}
