...
public class AutomaticTimetablingController extends GeneralController {
	...
	public String automaticSchedule(@RequestParam int semesterId,
		...
		int totalClassCourses = classCourseSemesterService
	...
	public String autoSchedule(
		...
		return "redirect:/staff/automaticTimetablingResult?semesterId="
				+ semesterId;
	}
	...
	public String clearSchedule(
		...
		httpSession.setAttribute("success",
				"Delete all timetable of semester successful!!!");
	...
	public String autoScheduleResult(
			@RequestParam(value = "semesterId", required = true) int semesterId,
			Model model, HttpSession httpSession, HttpServletRequest request) {
		...
		model.addAttribute("listClassWasSetTimetablesDone", scheduleInfoService
