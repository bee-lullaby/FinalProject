...
public class RoomsController extends GeneralController {
	...
	public String addRoomsFromFile(@RequestParam("file") MultipartFile file, HttpSession httpSession, Model model,
	...
	@RequestMapping(value = "/staff/rooms/updateRoom", method = RequestMethod.POST, params = { "roomId", "code",
			"capacity", "courses" })
	public String updateRooms(@RequestParam int roomId, @RequestParam String code, @RequestParam int capacity,
			@RequestParam String[] courses, HttpSession httpSession, Model model, HttpServletRequest request) {
		Room room = new Room();
		room.setCode(code);
