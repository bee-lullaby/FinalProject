...
public class Data {
	 ...
	 * @param args
	 */
	public int nbFCourses;// fragment course (fCourse), e.g., a course C
							// consists of 3 credits, then it has 3 fragments,
							// that can be attributed to 3 different slots
	public int nbTeachers;
	public int nbClasses;
	public int[] teacherOfFCourse;// teacherOfCourse[c] is the teacher who
									// teaches the fCourse c
	public int[] classOfFCourse;// classOfFCourse[c] is the class that is
								// learning the fCourse c
	public int nbDays = 5;// Mon,..., Fri
	public int nbSlotOfHalfDay = 3;// 3 slots in the morning and 3 slots in the
									// afternoon

	public int nbCourses;
	public ArrayList<Integer>[] fCourse;// fCourse[i] is the list of fCourse of
										// the course i
	public ArrayList<Integer>[] coursesOfClass;// courseOfClass[i] is the list
												// of course of class i
	public int[] courseOfFCourse;// courseOfFCourse[i] is the course of FCourse
									// i
	...
	public void loadData(String fn) {
		try {
			...
			while (true) {
				...
				int t = in.nextInt();
				int cl = in.nextInt();
				// System.out.println("c = " + c + ", t = " + t + ", nbTeachers
				// = " + nbTeachers + ", nbCourses = " + nbCourses);
				teacherOfCourse[c] = t;
				classOfCourse[c] = cl;
			}
			...
			while (true) {
				...
				if (fCourse[c] == null)
					fCourse[c] = new ArrayList<Integer>();
